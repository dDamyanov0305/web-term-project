...
class CStepper extends React.Component {
  constructor(props){
    super(props);
    this.state = {
      activeStep: 0,
  ...
  getStepContent = (step) => {
    switch (step) {
      case 0:
        return <AccountForm handleChange={this.props.handleChange} state={this.props.state}/>;
      case 1:
...
export default withStyles(styles)(CStepper);